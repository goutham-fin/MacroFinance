...
class simulation_model():
    ...
    def simulate(self):
        ...
        self.crisis_count = [0]
        for j in range(self.params['nsim']): #annualized z_trim (note the reshape) is compared against crisis_z to compute crisis_count
...
if __name__ == '__main__':
    ...
    params['IES']=1.5; params['utility'] = 'recursive_general'; params['nsim']=300
